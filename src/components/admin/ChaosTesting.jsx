...
export default function ChaosTesting() {
    ...
    return (
        <div className="p-[2px] rounded-xl bg-gradient-to-r from-[hsl(222,47%,11%)] via-[hsl(199,89%,48%)] to-[hsl(350,89%,60%)] h-full shadow-2xl">
            <div className="bg-card border border-border rounded-xl overflow-hidden h-full flex flex-col relative text-card-foreground">
                {/* Header */}
                <div className="p-6 bg-muted/30 border-b border-border flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Simulate production failures to test resilience</p>
                    </div>
                </div>
